...
public class RightFeederToFrontRocket extends Command {
  ...
  protected void initialize() {
    ...
    TrajectoryIterator<TimedState<Pose2dWithCurvature>> trajectory = new TrajectoryIterator<>(new TimedView<>(TrajectoryGenerator.getInstance().getTrajectorySet().rightFeederToFrontRocket.trajectory));
